...
import main.parser.SceneDescriptor;
...
public class SceneBuilder {
	...
	private final String SCENE_FILE_PATH = System.getProperty("user.dir") + "/src/main/scenes/";
	...
	public SceneBuilder(String sceneFileName, String destinationDirectory){
        ...
        _imageWriter = new ImageWriter(destinationDirectory +"scene", screenWidth, screenHeight,
